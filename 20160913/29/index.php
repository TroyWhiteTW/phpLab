...
$table = sepV1($iYear,$iMon,$iDay, $iYear_p, $iYear_n, $iMon_p, $iMon_n);
// 主程式
function sepV1($iYear, $iMon, $iDay , $iYear_p, $iYear_n, $iMon_p, $iMon_n){
	$iToday = $iDay;
...
// 結尾的table
	$sep.= "</table>\n";
// *做出上一年下一年上一月下一月的按鈕
	$sep.= btn($iYear, $iMon, $iYear_p, $iYear_n, $iMon_p, $iMon_n);
...
*做出按鈕
*/
function btn($iYear, $iMon, $iYear_p, $iYear_n, $iMon_p, $iMon_n){
	...
	"<input type='button' value='上一月' onclick='location.href=\"index.php?y=$iYear&m=$iMon_p\"' />".
	"<input type='button' value='下一月' onclick='location.href=\"index.php?y=$iYear&m=$iMon_n\"' />";
	return $sep;
}

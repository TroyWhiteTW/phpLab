...
function firstWeek($noDate, $monDays, $iYear, $iMon, $iDate){
	...
	for ($i = 1; $i <= 7; $i++){
		...
		if ($h[$iMon][$iDays][0] == 1){
			...
			$str [$i][4]="$iDays<br />{$h[$iMon][$iDays][2]}";
		}
	}
	// *指定或更改內容
	// 1999 5 1 顯示有問題
...
function holiday($iYear, $iMon, $iDays, $noDate){
	...
	$h = array();
	$h [$iMon][$iDays] = array(0, 0, '');
	$h [1][1] = array(1, 1912, '元旦');
	$h [2][28] = array(1, 1997, '和平紀念日');
	$h [3][8] = array(1, 1924, '婦女節');
	$h [3][29] = array(1, 1948, '青年節');
	$h [4][4] = array(1, 1931, '兒童節');
	$h [5][1] = array(1, 1985, '勞動節');
	// if ($noDate == 0){
		// $h [5][8] = array(1, 1913, '母親節');
	// }else{
		// $h [5][15 - $noDate] = array(1, 1913, '母親節');
	// }
	$h [5][$noDate==0?8:15-$noDate] = array(1, 1913, '母親節');
	$h [9][3] = array(1, 1955, '軍人節');
	$h [9][28] = array(1, 1952, '教師節');
	$h [10][10] = array(1, 1912, '國慶日');
	$h [12][25] = array(1, 1963, '行憲紀念日');
	// *處理節日開始年分的問題

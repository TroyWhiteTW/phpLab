...
function btn($iYear, $iMon){
	...
	// *做出按鈕
	$sep.="<input type='button' value='上一年' class='btn_y_p button1' onclick='location.href=\"index.php?y=$iYear_p&m=$iMon\"' />".
	"<input type='button' value='下一年' class='btn_y_n button1'onclick='location.href=\"index.php?y=$iYear_n&m=$iMon\"' />".
	"<input type='button' value='上個月' class='btn_m_p button2'onclick='location.href=\"index.php?y=$iYear_1&m=$iMon_p\"' />".
	"<input type='button' value='下個月' class='btn_m_n button2'onclick='location.href=\"index.php?y=$iYear_2&m=$iMon_n\"' />";
	return $sep;
}

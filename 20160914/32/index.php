...
function week(){
	...
	$week.= "<th class='weekend'>日</th>";
	$week.= "<th>一</th>";
	$week.= "<th>二</th>";
	$week.= "<th>三</th>";
	$week.= "<th>四</th>";
	$week.= "<th>五</th>";
	$week.= "<th class='weekend'>六</th>";
	$week.= "</tr>";
	return $week;
}
// *第三行之後出現日期
...
function btn($iYear, $iMon){
	...
	// *做出按鈕
	$btn.="<input type='button' value='上一年' class='btn_y_p button1' onclick='location.href=\"index.php?y=$iYear_p&m=$iMon\"' />";
	$btn.="<input type='button' value='下一年' class='btn_y_n button1'onclick='location.href=\"index.php?y=$iYear_n&m=$iMon\"' />";
	$btn.="<input type='button' value='上個月' class='btn_m_p button2'onclick='location.href=\"index.php?y=$iYear_1&m=$iMon_p\"' />";
	$btn.="<input type='button' value='下個月' class='btn_m_n button2'onclick='location.href=\"index.php?y=$iYear_2&m=$iMon_n\"' />";
	return $btn;
}

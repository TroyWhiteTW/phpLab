...
function holiday($iYear, $iMon, $iDays, $noDate){
	...
	$h [3][29] = array(2, 1948, '青年節<br />春假', 1);
	$h [3][30] = array(2, 1948, '春假', 1);
	$h [3][31] = array(2, 1948, '春假', 1);
	$h [4][1] = array(2, 1948, '春假', 1);
	$h [4][2] = array(2, 1948, '春假', 1);
	$h [4][3] = array(2, 1948, '春假', 1);
	$h [4][4] = array(2, 1931, '兒童節<br />掃墓節', 1);
